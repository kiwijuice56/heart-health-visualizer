...
signal panel_tapped(tapped_panel: SavedRecordingPanel)
...
func add_recording_panel(recording: Recording) -> void:
	...
	add_child(new_panel)
	new_panel.tapped.connect(_on_panel_tapped.bind(new_panel))
